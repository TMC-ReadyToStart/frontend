  ...
  return (
    <div className="relative">
      <div className="sticky top-0 left-0 p-2 pt-0 pl-0">
        <div className="flex absolute flex-col p-4 h-screen border shadow-sm bg-background">
          <h1>TMC</h1>
      ...
      <div className="flex-1 p-8 pt-6 pl-24 space-y-4 min-h-screen bg-slate-100">
